...
грузы приходят с кнопками «Открыть ATI · Подробнее · Игнорировать» только
если ATI API вернул подтверждённую ссылку на конкретную карточку. Если такой
ссылки нет, бот показывает отдельную кнопку «Открыть поиск ATI» или не
показывает внешнюю ссылку вовсе.
